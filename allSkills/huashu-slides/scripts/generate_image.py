...
# Configure logging for retry mechanism
...
def is_retryable_error(error: Exception) -> bool:
    """Check if error should trigger retry (503, connection errors, etc)."""
...
def main():
    ...
    try:
        # Use retry-enabled function for image generation
        response = generate_image_with_retry(client, contents, output_resolution)
