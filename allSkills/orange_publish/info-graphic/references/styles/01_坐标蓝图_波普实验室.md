...
每个模块需包含具体品牌名、数值、百分比及视觉符号建议（如：180°C、X轴、45度切角）
最右下角小字展示"模板by WaytoAGI"。
...
【STYLE KEYWORDS】
Coordinate Blueprint, Pop Lab, Technical Manual, Information Design, High-Density, Laboratory, Grid System, Fluorescent Accents
